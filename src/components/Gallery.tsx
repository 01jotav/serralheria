              ...
              <button
                ...
                className={`flex-none px-4 py-2.5 rounded-full text-sm font-medium transition-all whitespace-nowrap min-h-[44px] ${
                  categoriaAtiva === cat.value
                    ...
                    : "bg-navy-800 text-navy-200 active:bg-navy-700 active:text-white"
                }`}
              >
                {cat.label}
              </button>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            {fotosFiltradas.map((foto, index) => (
              ...
              >
                ...
                />
                {/* Placeholder */}
                <div className="absolute inset-0 flex flex-col items-center justify-center text-navy-400 pointer-events-none">
        ...
        <Dialog open={fotoAberta !== null} onOpenChange={fecharFoto}>
          <DialogContent
            className="
              ...
              bg-navy-950 border-0 sm:border-navy-700
              p-0 overflow-hidden
            "
          >
            {fotoAberta !== null && (
              ...
              >
                ...
                <div className="relative flex-1 min-h-0 bg-navy-900 sm:aspect-[4/3] sm:flex-none">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-navy-400 pointer-events-none">
                    ...
                    <p className="text-navy-300 text-sm text-center px-4">
                ...
                <div className="p-4 bg-navy-900 border-t border-navy-700 shrink-0">
                  <p className="text-white font-semibold">
                    {fotosFiltradas[fotoAberta].titulo}
                  </p>
                  <div className="flex items-center justify-between mt-1">
                    <p className="text-navy-200 text-sm capitalize">
                      {fotosFiltradas[fotoAberta].categoria}
                    </p>
                    <p className="text-navy-400 text-xs sm:hidden">
